 ...
 * @notice This is a test project for personal learning.
 */
contract NftMarketplace is ReentrancyGuard {
     ...
     * @param price Sale price for the NFT Listed.
     * @dev In this way owners can still hold their NFTs when listed.
     */
    ...
    function updateListing(address nftAddress, uint256 tokenId, uint256 updatedPrice)
        external
        isListed(nftAddress, tokenId)
        isOwner(nftAddress, tokenId, msg.sender)
    {
